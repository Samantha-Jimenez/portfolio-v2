...
const mvmntSlides = [
    <div className="flex justify-center h-full text-slate-500 px-7 py-4 flex-col gap-4 w-full text-sm md:text-base">
        ...
        <div className="gap-2 grid-flow-col inline-grid w-full">
            <a href="https://mvmntcollectives.com/" target="_blank" rel="noopener noreferrer" className="bg-white text-base shadow-lg px-4 py-2 inline-grid rounded-lg hover:shadow-inner w-full text-sm md:text-base">Live Site</a>
        </div>
    </div>,
];
...
const othelloSlides = [
    <div className="flex justify-center h-full text-slate-500 px-7 py-4 flex-col gap-4 w-full text-sm md:text-base">
        ...
        <div className="gap-2 grid-flow-col inline-grid w-full">
            <a href="https://github.com/dmorocho/othello" target="_blank" rel="noopener noreferrer" className="bg-gray-500 text-white shadow-lg px-4 py-2 inline-grid rounded-lg hover:shadow-inner w-full text-sm md:text-base">GitHub</a>
        </div>
    </div>,
];
...
const zooVioSlides = [
    <div className="image-crop-container flex flex-col items-center gap-4">
        ...
        <div className="gap-2 grid-flow-col inline-grid min-[1341px]:hidden text-center max-[403px]:grid-flow-row w-full">
            <a href="https://zoovio.netlify.app/" target="_blank" rel="noopener noreferrer" className="bg-white text-base shadow-lg px-4 py-2 inline-grid rounded-lg hover:shadow-inner text-center w-full text-sm md:text-base">Live Site</a>
            <a href="https://github.com/Zoovio-app/zoovio" target="_blank" rel="noopener noreferrer" className="bg-gray-500 text-white shadow-lg px-4 py-2 inline-grid rounded-lg hover:shadow-inner text-center w-full text-sm md:text-base">GitHub</a>
        </div>
    </div>,
    <div className="flex justify-center h-full text-slate-500 px-7 py-4 flex-col gap-4 w-full text-sm md:text-base">
        <p>
        ...
        <div className="gap-2 grid-flow-col inline-grid display text-center w-full max-[1340px]:hidden">
            <a href="https://zoovio.netlify.app/" target="_blank" rel="noopener noreferrer" className="bg-white text-base shadow-lg px-4 py-2 inline-grid rounded-lg hover:shadow-inner text-center w-full text-sm md:text-base">Live Site</a>
            <a href="https://github.com/Zoovio-app/zoovio" target="_blank" rel="noopener noreferrer" className="bg-gray-500 text-white shadow-lg px-4 py-2 inline-grid rounded-lg hover:shadow-inner text-center w-full text-sm md:text-base">GitHub</a>
        </div>
    </div>,
...
const finstaSlides = [
    <div className="image-crop-container flex flex-col items-center max-[365px]:gap-5">
        ...
        <div className="gap-2 grid-flow-col inline-grid text-center max-[403px]:grid-flow-row w-full min-[1466px]:hidden">
            <a href="https://github.com/SamanthaBJimenez/my-ig" target="_blank" rel="noopener noreferrer" className="bg-gray-500 text-white shadow-lg px-4 py-2 inline-grid rounded-lg hover:shadow-inner text-center w-full text-sm md:text-base">GitHub</a>
        </div>
    </div>,
    <div className="flex justify-center h-full text-slate-500 px-7 py-4 flex-col gap-4 w-full text-sm md:text-base">
        <p>
        ...
        <div className="gap-2 grid-flow-col inline-grid display max-[1465px]:hidden text-center w-full">
            <a href="https://github.com/SamanthaBJimenez/my-ig" target="_blank" rel="noopener noreferrer" className="bg-gray-500 text-white shadow-lg px-4 py-2 inline-grid rounded-lg hover:shadow-inner w-full text-sm md:text-base">GitHub</a>
        </div>
    </div>,
];
...
const tastebudsSlides = [
    <div className="image-crop-container flex flex-col items-center max-[365px]:gap-5">
        ...
        <div className="gap-2 grid-flow-col inline-grid min-[1355px]:hidden text-center max-[403px]:grid-flow-row w-full">
            <a href="https://tastebuds.netlify.app/" target="_blank" rel="noopener noreferrer" className="bg-white text-base shadow-lg px-4 py-2 inline-grid rounded-lg hover:shadow-inner w-full text-sm md:text-base">Live Site</a>
            <a href="https://github.com/SamanthaBJimenez/tastebuds" target="_blank" rel="noopener noreferrer" className="bg-gray-500 text-white shadow-lg px-4 py-2 inline-grid rounded-lg hover:shadow-inner w-full text-sm md:text-base">GitHub</a>
        </div>
    </div>,
    <div className="flex justify-center h-full text-slate-500 px-7 py-4 flex-col gap-4 w-full text-sm md:text-base">
        <p>
